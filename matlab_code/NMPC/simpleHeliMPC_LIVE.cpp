...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) 
 { 
    ...
    acadodata_f1 << dot(xd) == (qw*qy+qx*qz)*2.00000000000000000000e+00*3.74996489349999961860e+01*col;
    acadodata_f1 << dot(yd) == (-qw*qx+qy*qz)*2.00000000000000000000e+00*3.74996489349999961860e+01*col;
    acadodata_f1 << dot(zd) == ((pow(qw,2.00000000000000000000e+00)-pow(qx,2.00000000000000000000e+00)-pow(qy,2.00000000000000000000e+00)+pow(qz,2.00000000000000000000e+00))*3.74996489349999961860e+01*col+9.80664999999999942304e+00);
    acadodata_f1 << dot(p) == ((-2.71083520832768591902e+01)*p+1.40012556177438682425e+02*roll);
