...
START_DIR                 = /Users/stevenmessinger/Documents/GitHub/L1_MPC-HELI/matlab_code/EKF/C++/codegen/lib/foo
TGT_FCN_LIB               = ISO_C++
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I/Users/stevenmessinger/Documents/GitHub/L1_MPC-HELI/matlab_code/EKF/C++ -I$(MATLAB_ROOT)/extern/include
...
SRCS = $(START_DIR)/foo_data.cpp $(START_DIR)/foo_initialize.cpp $(START_DIR)/foo_terminate.cpp $(START_DIR)/foo.cpp $(START_DIR)/EKF.cpp
...
OBJS = foo_data.o foo_initialize.o foo_terminate.o foo.o EKF.o
...
%.o : /Users/stevenmessinger/Documents/GitHub/L1_MPC-HELI/matlab_code/EKF/C++/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : /Users/stevenmessinger/Documents/GitHub/L1_MPC-HELI/matlab_code/EKF/C++/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
