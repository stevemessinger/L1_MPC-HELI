...
#else
#define TR_USBMODES                    TR("Ask\0  ""Joyst\0""SDCard""Telem\0", "Ask\0    ""Joystick""Storage\0""SerTelem")
#endif
#endif
...
#define TR_BATTERYWARNING              INDENT "Battery low"
  ...
  #define TR_CRITICALBATTERYLEVEL      "Critical Batt. Level"
  #define TR_SHUTDOWNINXXS             "Shutdown In xxs?"
#endif
...
#define TR_BG                          "BG:"
  ...
  #define TR_LEFT                      "\005LEFT"
  #define TR_RIGHT                     "\005RIGHT"
  #define TR_BOTH                      "\005BOTH"
  #define TR_SETMIDPOINT               CENTER "\004CENTER POTS/SLIDERS"
  #define TR_MOVESTICKSPOTS            CENTER "\006MOVE POTS/SLIDERS"
  #define TR_MOVESTICK_P0              CENTER "\004HOLD STICK AT CENTER"
  #define TR_MOVESTICK_P1              CENTER "\004HOLD AT MIDDLE RIGHT"
  #define TR_MOVESTICK_P2              CENTER "\006HOLD AT TOP RIGHT"
  #define TR_MOVESTICK_P3              CENTER "\006HOLD AT TOP MIDDLE"
  #define TR_MOVESTICK_P4              CENTER "\007HOLD AT TOP LEFT"
  #define TR_MOVESTICK_P5              CENTER "\004HOLD AT MIDDLE LEFT"
  #define TR_MOVESTICK_P6              CENTER "\004HOLD AT BOTTOM LEFT"
  #define TR_MOVESTICK_P7              CENTER "\003HOLD AT BOTTOM MIDDLE"
  #define TR_MOVESTICK_P8              CENTER "\003HOLD AT BOTTOM RIGHT"
  #define TR_CAL_POINTS                CENTER "\002CALCULATING CONSTANTS"
  #define TR_RELEASE_STICK             CENTER "\006RELEASE THE STICK"
  #define TR_MOVE_PLUS                 CENTER "\005MOVE IN \"+\" PATTERN"
  #define TR_MENUWHENDONE              CENTER "\006" TR_ENTER " WHEN DONE"
  #define TR_JOYSTICK_RF               "RF in Joystick Mode"
  #define TR_TURN_OFF_RF               "Turn off RF?"
  #define TR_UPDATE_CROSSFIRE          "Pls Update Crossfire"
#else
  #define TR_MENUTOSTART               CENTER "\010" TR_ENTER " TO START"
...
#if defined(RADIO_FAMILY_TBS)
    #define TR_CROSSFIRE               "Crossfire"
    #define TR_RECEIVER_NUM            TR("ModelMatch", "Receiver No.")
#else
...
#if defined(RADIO_FAMILY_TBS)
#define TR_USB_AGENT                   "USB Agent (HID)"
#define TR_USB_CHARGE                  "USB Charging"
#endif
